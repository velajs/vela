...
is 1.x. Breaking changes use minor releases; backward compatibility is not required.
Remove obsolete APIs directly and update affected examples and documentation.
