# Coordinated security-major release
...
1. Publish the independent foundations:
   `@velajs/errors@1.1.0`, `@velajs/live-protocol@2.0.0`,
...
2. Publish `@velajs/vela@2.0.0`. Its release preflight requires Live Protocol
   2 to be visible in the public registry.
3. Publish the Vela-only consumers: `@velajs/authz@2.0.0`,
   `@velajs/testing@1.0.0`, `@velajs/mail@1.0.0`, `@velajs/crud@2.0.0`
   with its coordinated adapter majors, `@velajs/cli@1.0.0`, and
...
5. Publish `@velajs/better-auth@1.0.0`,
   `@velajs/cloudflare-access@1.0.0`, and `@velajs/cloudflare@2.0.0`.
